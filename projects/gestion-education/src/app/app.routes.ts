...
export const routes: Routes = [
  ...
  { path: 'notes-bulletin', loadComponent: () => import('./pages/notes/notes-bulletin.component').then(m => m.NotesBulletinComponent), canActivate: [roleGuard], data: { roles: ['hr'] } },
  { path: 'bulletins-historique', loadComponent: () => import('./pages/bulletins-historique/bulletins-historique.component').then(m => m.BulletinsHistoriqueComponent), canActivate: [roleGuard], data: { roles: ['hr'] } },
  { path: 'eleves', loadComponent: () => import('./pages/eleves/eleves.component').then(m => m.ElevesComponent), canActivate: [roleGuard], data: { roles: ['hr'] } },

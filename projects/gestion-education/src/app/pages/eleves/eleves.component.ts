...
export class ElevesComponent {
  ...
  form     = { nom:'', prenom:'', dateNaissance:'', classe:'CP', parentNom:'', parentTel:'' };
  ...
  addEleve() {
    ...
    this.eleves.update(list => [...list, {
      id, matricule: `EDU-2024-${String(id).padStart(3,'0')}`,
    ...
    this.form = { nom:'', prenom:'', dateNaissance:'', classe:'CP', parentNom:'', parentTel:'' };

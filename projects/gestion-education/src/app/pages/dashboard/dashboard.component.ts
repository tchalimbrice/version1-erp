...
export class DashboardComponent {
  ...
  get totalEleves()      { return this.niveaux.reduce((s, n) => s + n.total, 0); }
  get totalEnseignants() { return 42; }
  get totalClasses()     { return this.niveaux.reduce((s, n) => s + n.classes, 0); }
  get tauxPaiement()     { return 78; }

  alertes = [
    { titre: 'Scolarités impayées',  msg: '48 élèves avec arriérés > 2 mois',          icon: '⚠️', color: '#b7950b', bg: '#fef9e7' },

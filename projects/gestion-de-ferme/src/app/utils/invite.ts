import type { CompanyData, Collaborator, Role } from '../services/collab-store.service';

export type InviteDomain = 'gestion-de-ferme';
...
export function decodeInvite(raw: string): InvitePayloadV1 | undefined {
  try {
    ...
    if (!parsed || parsed.v !== 1 || parsed.domain !== 'gestion-de-ferme') return undefined;

...
// projects/gestion-logistique/src/app/guards/role.guard.ts
var roleGuard = (route) => {
...
// projects/gestion-logistique/src/app/app.routes.ts
var routes = [
  { path: "", redirectTo: "/connexion", pathMatch: "full" },
  { path: "connexion", loadComponent: () => import("./chunk-P4YSDMTT.js").then((m) => m.ConnexionComponent) },
  { path: "dashboard", loadComponent: () => import("./chunk-GHJ6WCFT.js").then((m) => m.DashboardComponent), canActivate: [roleGuard], data: { roles: ["owner"] } },
  { path: "parametres", loadComponent: () => import("./chunk-R5O6T6LJ.js").then((m) => m.ParametresComponent), canActivate: [roleGuard], data: { roles: ["owner"] } },
  { path: "commandes", loadComponent: () => import("./chunk-ZYD76J7L.js").then((m) => m.CommandesComponent), canActivate: [roleGuard], data: { roles: ["employee"] } },
  { path: "livraisons", loadComponent: () => import("./chunk-FHD246NU.js").then((m) => m.LivraisonsComponent), canActivate: [roleGuard], data: { roles: ["employee"] } },
  { path: "vehicules", loadComponent: () => import("./chunk-5U7MKYGM.js").then((m) => m.VehiculesComponent), canActivate: [roleGuard], data: { roles: ["employee"] } },
  { path: "entrepots", loadComponent: () => import("./chunk-CYUXN7Y2.js").then((m) => m.EntrepotsComponent), canActivate: [roleGuard], data: { roles: ["employee"] } },
  { path: "clients", loadComponent: () => import("./chunk-3LA3NUY4.js").then((m) => m.ClientsComponent), canActivate: [roleGuard], data: { roles: ["employee"] } },
  { path: "suivi-temps-reel", loadComponent: () => import("./chunk-UXNBW45X.js").then((m) => m.SuiviTempsReelComponent), canActivate: [roleGuard], data: { roles: ["employee"] } },
  { path: "chauffeurs", loadComponent: () => import("./chunk-2YRGK66Z.js").then((m) => m.ChauffeursComponent), canActivate: [roleGuard], data: { roles: ["hr"] } },
  { path: "facturation", loadComponent: () => import("./chunk-SNWC7HDJ.js").then((m) => m.FacturationComponent), canActivate: [roleGuard], data: { roles: ["accountant"] } },
  { path: "**", redirectTo: "/connexion" }
];

// projects/gestion-logistique/src/app/app.config.ts
var appConfig = {
  providers: [
    provideBrowserGlobalErrorListeners(),
...
// projects/gestion-logistique/src/app/app.ts
...
var App = class _App {
  ...
  roleFr(role) {
    const map = {
      ...
      employee: "Employ\xE9 Logistique",
      hr: "Responsable RH",
  ...
  linksForRole(role) {
    if (role === "owner" && this.store.mode() === "centralized")
      return [
        ...
        { label: "V\xE9hicules", path: "/vehicules" },
        { label: "Entrep\xF4ts", path: "/entrepots" },
        { label: "Clients", path: "/clients" },
        { label: "Suivi temps r\xE9el", path: "/suivi-temps-reel" },
    ...
    <aside class="sidebar">
      <div class="sidebar__brand">
        ...
        <div class="sidebar__brand-text">
          <span class="sidebar__brand-sub">LOGISTIQUE</span>
...
`, styles: ["/* projects/gestion-logistique/src/app/app.scss */\n.layout {\n  display: flex;\n  height: 100vh;\n  overflow: hidden;\n}\n.sidebar {\n  width: 230px;\n  min-width: 230px;\n  background:\n    linear-gradient(\n      180deg,\n      #0d2137 0%,\n      #102a48 100%);\n  display: flex;\n  flex-direction: column;\n  overflow-y: auto;\n}\n.sidebar__brand {\n  display: flex;\n  align-items: center;\n  gap: 10px;\n  padding: 22px 16px 20px;\n  border-bottom: 1px solid rgba(255, 255, 255, 0.07);\n}\n.sidebar__brand-icon {\n  width: 38px;\n  height: 38px;\n  background:\n    linear-gradient(\n      135deg,\n      #3498db,\n      #1a6fa8);\n  border-radius: 10px;\n  display: grid;\n  place-items: center;\n  font-size: 18px;\n}\n.sidebar__brand-text {\n  display: flex;\n  flex-direction: column;\n}\n.sidebar__brand-sub {\n  font-size: 10px;\n  color: rgba(255, 255, 255, 0.38);\n  letter-spacing: 1.5px;\n  font-weight: 700;\n  text-transform: uppercase;\n}\n.sidebar__brand-name {\n  font-size: 13px;\n  font-weight: 800;\n  color: #fff;\n  white-space: nowrap;\n  overflow: hidden;\n  text-overflow: ellipsis;\n  max-width: 154px;\n}\n.sidebar__nav {\n  flex: 1;\n  display: flex;\n  flex-direction: column;\n  gap: 2px;\n  padding: 14px 10px;\n}\n.sidebar__link {\n  display: flex;\n  align-items: center;\n  gap: 10px;\n  padding: 9px 12px;\n  border-radius: 10px;\n  color: rgba(255, 255, 255, 0.48);\n  text-decoration: none;\n  font-size: 13px;\n  font-weight: 500;\n  transition: background 0.15s, color 0.15s;\n  white-space: nowrap;\n}\n.sidebar__link:hover {\n  background: rgba(255, 255, 255, 0.06);\n  color: rgba(255, 255, 255, 0.88);\n}\n.sidebar__link--active {\n  background: rgba(52, 152, 219, 0.22);\n  color: #5dade2;\n  font-weight: 700;\n}\n.sidebar__link-ic {\n  font-size: 14px;\n  width: 20px;\n  text-align: center;\n  opacity: 0.8;\n}\n.sidebar__home-link {\n  display: block;\n  margin: 0 10px 8px;\n  padding: 7px 12px;\n  border-radius: 8px;\n  color: rgba(255, 255, 255, 0.25);\n  text-decoration: none;\n  font-size: 11px;\n  font-weight: 600;\n  letter-spacing: 0.5px;\n  border: 1px solid rgba(255, 255, 255, 0.08);\n  text-align: center;\n  transition: color 0.15s, background 0.15s;\n}\n.sidebar__home-link:hover {\n  color: rgba(255, 255, 255, 0.6);\n  background: rgba(255, 255, 255, 0.05);\n}\n.sidebar__footer {\n  display: flex;\n  align-items: center;\n  gap: 10px;\n  padding: 14px 12px;\n  border-top: 1px solid rgba(255, 255, 255, 0.07);\n}\n.sidebar__avatar {\n  width: 34px;\n  height: 34px;\n  border-radius: 50%;\n  background: rgba(52, 152, 219, 0.25);\n  color: #5dade2;\n  display: grid;\n  place-items: center;\n  font-weight: 800;\n  font-size: 12px;\n  flex-shrink: 0;\n}\n.sidebar__user-info {\n  flex: 1;\n  overflow: hidden;\n  display: flex;\n  flex-direction: column;\n}\n.sidebar__user-name {\n  font-size: 12px;\n  font-weight: 700;\n  color: rgba(255, 255, 255, 0.88);\n  white-space: nowrap;\n  overflow: hidden;\n  text-overflow: ellipsis;\n}\n.sidebar__user-role {\n  font-size: 11px;\n  color: rgba(255, 255, 255, 0.38);\n  white-space: nowrap;\n  overflow: hidden;\n  text-overflow: ellipsis;\n}\n.sidebar__logout-btn {\n  background: none;\n  border: none;\n  color: rgba(255, 255, 255, 0.32);\n  cursor: pointer;\n  font-size: 16px;\n  padding: 4px;\n  border-radius: 6px;\n  transition: color 0.15s;\n  flex-shrink: 0;\n}\n.sidebar__logout-btn:hover {\n  color: rgba(255, 255, 255, 0.85);\n}\n.main-content {\n  flex: 1;\n  overflow-y: auto;\n  background: #f0f4f8;\n}\n/*# sourceMappingURL=app.css.map */\n"] }]
...
// projects/gestion-logistique/src/main.ts
